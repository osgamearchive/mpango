...
(function (window, undefined) {
    ...
    jQuery.support = (function () {
        ...
        var div = document.createElement("div"),
            ...
            all, a, select, opt, input, marginDiv, support, fragment, body, bodyStyle, tds, events, eventName, i, isSupported;
...
(function ($) {
    ...
    $.fn.tweet = function (o) {
        var s = $.extend({
            username: null,
            // [string or array] required unless using the 'query' option; one or more twitter screen names
            list: null,
        ...
        return this.each(function (i, widget) {
            ...
            $(widget).bind("load", function () {
                $.getJSON(build_url(), function (data) {
                    ...
                    list.append($.map(tweets, function (t) {
...
//
(function () {
    jQuery(function () { /** Search on hover effect, focus effect, and double-click to erase value **/
        ;
        var Menus, hasFocci, makeShort, makeTall, pricingcolumn, pricingrowselector;
        hasFocci = false;
        jQuery('#search_input').focus(function () {
            jQuery(this).stop().animate(function () {
                return {
                    "opacity": "1",
                    queue: false,
                    duration: 300
            ...
            return hasFocci = false;
        }).dblclick(function () {
            jQuery(this).val('');
            return hasFocci = true;
        });
        jQuery('#search_submit').add('#search_input').hover(function () {
            return jQuery(this).stop().animate(function () {
                return {
                    "opacity": "1",
                    queue: false,
                    duration: 300
        ...
        jQuery('#menu > ul > li').prepend('<span class="menu_box_left"></span>').append('<span class="menu_box_right"></span>'); /** Menu jQuery rollout, additional styling allowing for rounded borders **/
        ;
        Menus = jQuery('#menu ul li');
        ...
        Menus.hover(function () {
            ...
            return jQuery('span.menu_box_right', this).addClass('menu_box_right_bg');
        }, function () {
            ...
            return jQuery('span.menu_box_right', this).removeClass('menu_box_right_bg');
        });
        Menus.hoverIntent({
            over: makeTall,
            timeout: 300,
        ...
        makeShort = function () {
            return jQuery(this).find('ul:first').fadeOut({
                queue: true,
                duration: 200
            });
        ...
        ;
        jQuery('.inner_main .hr').append('<div class="inner_hr"></div>'); /** Pricing Table **/
        ;
        pricingcolumn = jQuery('.pricing_column');
        pricingcolumn.hover(function () {
            return jQuery(this.$).find('.pricing_blurb').animate({
                top: '10px'
            }, 300);
        }, function () {
            return jQuery(this).find('.pricing_blurb').animate({
        ...
        ;
        pricingrowselector = jQuery('.pricing');
        pricingrowselector.each(function () {
            var finalresult, numberofcolumns, widthofrow;
            numberofcolumns = jQuery(this).find('.pricing_column').length;
            widthofrow = jQuery(this).parent().width();
            finalresult = 11 + Math.floor(((widthofrow - 2) - (numberofcolumns * 168)) / (numberofcolumns * 2));
        ...
        ;
        jQuery(".tweeter_widget").tweet(function () {
            return {
        ...
        jQuery('#slider').css({
            display: "block"
        }).hide(); /** Social networking icons fade on hover **/
        ;
        ...
        jQuery('input').blur(function () {
            if (jQuery(this).val() === '') {
                return jQuery(this).val(jQuery(this).attr('title'));
            }
        ...
        jQuery("area[rel^='prettyPhoto']").add('.zoomer').prettyPhoto(); /** Toggler **/
        ;
        jQuery('div.toggler:not(.open)').hide();
        return jQuery('.toggle').click(function () {
            return jQuery(this).toggleClass("active").next().slideToggle("fast");
        });
    });
}).call(this);
(function () {
