...
/**
 * <p>This interface offers the methods in order to implement a TaskCommand class.
 ...
 * </ol>
 * Developers are encouraged to extend the {@link AbstractTaskCommand} class that already has built in functionality and to
